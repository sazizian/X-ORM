...
ALTER TABLE `Teller`
  ADD CONSTRAINT `FK_Teller_Customer_CustomerID_idx` FOREIGN KEY (`CustomerID`) REFERENCES `Customer` (`CustomerID`) ON DELETE CASCADE ON UPDATE CASCADE;
